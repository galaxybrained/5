...
def clear_screen():
    ...
    if platform.system() == 'Windows':
        os.system('cls')
    elif platform.system() == 'Linux' and 'TERMUX' in os.environ:
        os.system('clear')
    else:
        os.system('clear')
...
def derive_key(passphrase, salt):
    key = scrypt(passphrase, salt, key_len=32, N=16384, r=8, p=1)
    return key
...
def store_key(key, passphrase, key_file):
    ...
    os.chmod(key_file, 0o600)  # Restrict access permissions
